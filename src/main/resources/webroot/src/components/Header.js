                        ...
                        <a title="qDup Web Console" href="/">
                            <svg width="300px" height="150px" viewBox="0 0 300 150">
                                <g className="asd" strokeWidth="1.6" fill="none" fillRule={"evenodd"}>
                                    ...
                                    <text textAnchor="start" fontFamily="Oswald, sans-serif" fontSize="100" id="svg_2"
                                          y="105" x="120" fillOpacity="null" strokeOpacity="null" strokeWidth="0"
                                          stroke="#fff" fill="#ffffff">Dup
                                    </text>
                ...
                <div
                    ...
                    <nav className="actionCont collapsed">
                        <div className="actionItem">
                            <a className="aiButton" id="active" title="Shortcut: Command/Ctrl + A" href="#active"
                        ...
                        <div className="actionItem">
                            <a className="aiButton" id="latches" title="Shortcut: Command/Ctrl + L" href="#latches"
                        ...
                        <div className="actionItem visible ">
                            <a className="aiButton" id="counters" title="Shortcut: Command/Ctrl + C" href="#counters"
                               onClick={this.showCounters.bind(this)}>
                                <svg
                                    ...
                                    strokeLinejoin="round"
                                    className="feather feather-upload-cloud">
                                    <text style={{cursor: "move"}} textAnchor="start"
                                          fontFamily="Helvetica, Arial, sans-serif" fontSize="14" id="svg_1"
                                          y="16.84375" x="2.601563" strokeWidth="0" stroke="#FFF" fill="#FFFFF"> 0 0 0 1
                                    </text>
                                    <line id="svg_2" y2="0" x2="0" y1="0" x1="48" stroke="#FFF" fill="none"/>
                                    <line id="svg_3" y2="0" x2="0" y1="24" x1="0" stroke="#FFF" fill="none"/>
                                    <line id="svg_5" y2="24" x2="0" y1="24" x1="48" fillOpacity="null"
                                          strokeOpacity="null" strokeWidth="null" stroke="#FFF" fill="none"/>
                                    <line id="svg_7" y2="0" x2="48" y1="24" x1="48" fillOpacity="null"
                                          strokeOpacity="null" strokeWidth="null" stroke="#FFF" fill="none"/>
                                    <line id="svg_8" y2="24" x2="12" y1="0" x1="12" fillOpacity="null"
                                          strokeOpacity="null" strokeWidth="null" stroke="#FFF" fill="none"/>
                                    <line id="svg_9" y2="24" x2="24" y1="0" x1="24" fillOpacity="null"
                                          strokeOpacity="null" strokeWidth="null" stroke="#FFF" fill="none"/>
                                    <line id="svg_10" y2="24" x2="36" y1="0" x1="36" fillOpacity="null"
                                          strokeOpacity="null" strokeWidth="null" stroke="#FFF" fill="none"/>
                                </svg>
                        ...
                        <div className="actionItem visible">
                            <a className="aiButton" id="pendingDownloads" title="Fork into a new fiddle" href="#pending"
